  ...
  return (
    <section className="w-full  mx-auto border-t border-primary">
      <div className="flex flex-col md:flex-row ">
        ...
        {/* Right Side - Content */}
        <div
          className="flex-1  flex-shrink-0  border-primary md:border-l md:border-t-0"
        >
          <div className="px-8 py-12 md:px-20 md:py-20 flex flex-col gap-16">
            {/* Text Content */}
            <div className="flex flex-col gap-6">
              {/* Overline Label */}
              <FadeIn as="span" delay={0.1} className="text-sm font-medium leading-tight uppercase text-primary">
                Our story
              </FadeIn>

              {/* Title */}
              <FadeIn as="h3" delay={0.2} className="text-3xl md:text-4xl font-medium leading-tight text-primary">
                Kyiv LuxeBouquets
              </FadeIn>

              {/* Description */}
              <FadeIn as="p" delay={0.3} className="text-base leading-relaxed text-primary-muted">
