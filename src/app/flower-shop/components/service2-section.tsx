      ...
      >
        <div className="flex flex-col gap-16 items-center">
          ...
          <div className="flex flex-col gap-6 items-center text-white">
            <FadeIn as="p" delay={0.3} className="text-sm font-medium uppercase tracking-widest">
              service
            </FadeIn>
            <div className="flex flex-col gap-4 items-center">
              <FadeIn as="h2" delay={0.4} className="text-4xl md:text-5xl font-semibold leading-tight text-center">
                Wedding & Event Decor
              </FadeIn>
              <FadeIn as="p" delay={0.5} className="text-lg font-medium leading-relaxed text-center max-w-[586px] opacity-90">
